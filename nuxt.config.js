...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Order double yolked eggs in Dhaka or anywhere in Bangladesh Online' },
  ...
  pwa: {
    manifest: {
      name: 'Double Yolked Eggs from Nutribites',
      short_name: 'Order Eggs',
      lang: 'en',
      theme_color: '#f9f4d6',
    },
  },
